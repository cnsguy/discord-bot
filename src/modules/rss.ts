  ...
  private constructor(private readonly bot: Bot) {
    bot.registerCommand(
      new Command(
        ...
        1,
        3,
        (interaction) => this.rssMonitorLinkCommand(interaction)
      )
    );
    ...
    bot.registerCommand(
      new Command(
        ...
        0,
        0,
        (interaction) => this.rssMonitorListCommand(interaction)
      )
    );
    ...
    bot.registerCommand(
      new Command(
        ...
        0,
        0,
        (interaction) => this.rssUnmonitorAllCommand(interaction)
      )
    );
